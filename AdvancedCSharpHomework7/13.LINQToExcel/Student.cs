...
namespace _13.LINQToExcel
{
    public class Student
    {
        ...
        public Student(int iD, string firstName, string lastName, string email, string gender, string studentType, int examResult, int homeworkSent,
            int homeworkEvaluated, double teamwork, int attendances, double bonus)
        {
            ID = iD;
            FirstName = firstName;
            LastName = lastName;
